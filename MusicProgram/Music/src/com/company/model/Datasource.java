...
public class Datasource {
    ...
    public static final String CONNECTION_STRING="jdbc:sqlite:/Users/enhui/Desktop/UdemyJava/MusicProgram/Music/"+DB_NAME;
    ...
    public void close(){
        try{
            ...
            System.out.println("Couldn't close to connection :"+ e.getMessage());
        }
    }
    ...
    public List<Artist> queryArtists(int sortOrder){
        ...
        //use try with statement, after the try block. statement && resultSet will be close automatically.
        ...
        //Don't need this finally block. if we use try with statement.
//        finally{
//            try{
//                if(results!=null){
//                    results.close();
